...
<head>
    ...
    <title>{{ config('app.name', 'EasyOrder') }}</title>
...
<body>
    <div id="app" class="min-h-screen flex flex-col">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand font-bold text-xl flex items-center gap-2" href="{{ url('/') }}">
                    <img src="{{ asset('images/screenshots/Logo.jpg') }}" alt="Logo" class="h-10 w-10 object-contain rounded-full" style="max-height:40px;">
                    {{ __('EasyOrder') }}
                </a>
