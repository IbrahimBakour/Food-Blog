    ...
    <div class="shadow sm:rounded-md sm:overflow-hidden">
      <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
        ...
        <div>
          ...
          <div>
          <select name="type" id="type" class="flex justify-center mt-1 rounded-md shadow-sm p-1 border focus:ring-indigo-500 focus:border-indigo-500 flex-1 w-full sm:text-lg border-gray-300">
